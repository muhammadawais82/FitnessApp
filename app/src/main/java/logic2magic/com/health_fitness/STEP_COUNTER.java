...
public class STEP_COUNTER extends AppCompatActivity {
        ...
        stopServiceBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!isServiceStopped) {
                    ...
                    CalorieBurnedCalculator  c = new CalorieBurnedCalculator();

                    stepCountTxV.setText(stepCountTxV.getText().toString()+"\n"+c.colroires_result(step_counter));
                }
            }
        });
    ...
    private void updateViews(Intent intent) {
        ...
        step_counter = Integer.valueOf(DetectedStep);
